        ...
        if($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 2){
            ...
            if(isset($_REQUEST['sub'])){
                ...
                if(isset($_REQUEST['submit'])){
                    ...
                    if ($_REQUEST['nama'] == "" || $_REQUEST['alamat'] == "" || $_REQUEST['kepsek'] == ""
                        ...
                        if(!preg_match("/^[a-zA-Z0-9. -]*$/", $nama)){
                            ...
                            if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $alamat)){
                                ...
                                if(!preg_match("/^[a-zA-Z., ]*$/", $kepsek)){
                                    $_SESSION['kepsek'] = 'Form Nama Kepala BNNP hanya boleh mengandung karakter huruf, spasi, titik(.) dan koma(,)<br/><br/>';
                                    echo '<script language="javascript">window.history.back();</script>';
                                } else {
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input id="kepsek" type="text" class="validate" name="kepsek" value="<?php echo $row['kepsek']; ?>" required>
                                            ...
                                            ?>
                                        <label for="kepsek">Nama Kepala BNNP</label>
                                    </div>
                                    <div class="input-field col s6">
